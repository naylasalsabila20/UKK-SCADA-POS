...
<html lang="en">
  <head>
    ...
    <script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/1.11.6/js/dataTables.bootstrap4.min.js"></script>
    <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/1.11.6/css/dataTables.bootstrap4.min.css">
    <script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/1.11.6/js/jquery.dataTables.js"></script>
    <script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/1.11.6/js/dataTables.bootstrap4.min.js"></script>
  ...
  <body >
        ...
        <div class="container-xl">
          ...
          <div class="navbar-nav flex-row order-md-last">
            <div class="d-none d-md-flex">
              <a href="<?=base_url('?theme=dark');?>" class="nav-link px-0 hide-theme-dark" title="Enable dark mode" data-bs-toggle="tooltip"
		   data-bs-placement="bottom">
                <!-- Download SVG icon from http://tabler-icons.io/i/moon -->
                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 3c.132 0 .263 0 .393 0a7.5 7.5 0 0 0 7.92 12.446a9 9 0 1 1 -8.313 -12.454z" /></svg>
              </a>
              <a href="<?=base_url('?theme=light');?>" class="nav-link px-0 hide-theme-light" title="Enable light mode" data-bs-toggle="tooltip"
		   data-bs-placement="bottom">
            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                <span class="avatar avatar-sm" style="background-image: url(<?=base_url('dist/img/profile.jpg');?>)"></span>
          ...
          <div class="collapse navbar-collapse" id="navbar-menu">
            <div class="d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center">
              <ul class="navbar-nav">
                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      <div class="dropdown-menu-column">
                        <a class="dropdown-item" href="<?=site_url('master-data-satuan');?>">
                          Satuan
                        </a>
                        <a class="dropdown-item" href="<?=site_url('master-data-kategori');?>">
                          Kategori
                        </a>
                      </div>
                      <div class="dropdown-menu-column">
					  <a class="dropdown-item" href="<?=site_url('master-data-produk');?>">
                          Produk
                        </a>
                        <a class="dropdown-item" href="<?=site_url('master-data-pengguna');?>">
                          Pengguna
                        </a>
                      </div>
                    </div>
                ...
                <li class="nav-item">
                  <a class="nav-link" href="<?=site_url('transaksi-penjualan')?>" >
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      <div class="dropdown-menu-column">
                        <a class="dropdown-item" href="<?=site_url('laporan-stok');?>">
                          Stok produk
                        </a>
						<?php if(session()->get('level') == 'admin') { ?>
                        <a class="dropdown-item" href="<?=site_url('laporan-penjualan');?>">
                          Penjualan
                        </a>
						<?php } ?>
                      </div>
            ...
            <div class="row text-center align-items-center flex-row-reverse">
              <div class="col-lg-auto ms-lg-auto">
                <ul class="list-inline list-inline-dots mb-0">
                  <li class="list-inline-item">naiscode</li>
                </ul>
              </div>
              <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                <ul class="list-inline list-inline-dots mb-0">
                  <li class="list-inline-item">
                    Copyright &copy; 2024
                    <a href="." class="link-secondary">SCADA POS</a>
                  </li>
                </ul>
              </div>
            </div>
	...
	<script src="<?=base_url('dist/select2/js/select2.min.js');?>" defer></script>
...
$(document).ready(function() {
    $('#moneyInput2').on('input', function() {
        ...
        $('#formattedMoney').text(value);
    });
    
    // Function to format money with dots
